...
The Standardised Beta show that players that wish to increase their odds of winning the award should focuse on hitting the ball more (increasing b_H), followed by hitting Home Run's (b_HR), and avoiding Striking Out (b_SO).
